...
if not os.path.exists('snapshot'):
    os.mkdir('snapshot')
base_weights = '../../models/bvlc_googlenet/fcn_8stride/fcn-googlenet_8stride_early.caffemodel'
...
for it in range(niter):
    ...
    if it % 500 ==0:
        ...
        solver.net.save('D:/camvid_experiment_07/fcn-googlenet8-early_camvid_finetune_iter_' + repr(it) + '.caffemodel')
        np.save('D:/camvid_experiment_07/loss-googlenet8-early_camvid_finetune_iter_' + repr(it) + '.npy',train_loss)
print 'done'