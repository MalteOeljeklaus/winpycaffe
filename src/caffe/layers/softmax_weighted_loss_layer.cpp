...
void SoftmaxWithWeightedLossLayer<Dtype>::LayerSetUp(
  ...
  // code below added from original caffe sources by MO~27.01.2016
  LayerParameter softmax_param(this->layer_param_);
  softmax_param.set_type("Softmax");
  softmax_layer_ = LayerRegistry<Dtype>::CreateLayer(softmax_param);
  // code above added from original caffe sources by MO~27.01.2016
  ...
  WeightedSoftmaxLossParameter softmaxloss_param = this->layer_param_.softmaxloss_param();
