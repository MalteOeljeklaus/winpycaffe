...
if exist ".\3rdparty" (
	...
	if exist ".\cudnn-7.0-win-x64-v4.0-prod.zip" (
		...
		del 3rdparty_tmp.7z
		call .\tools\7z938-extra\7za.exe e -y cudnn-7.0-win-x64-v4.0-prod.zip -o3rdparty\lib cuda\lib\x64
		call .\tools\7z938-extra\7za.exe e -y cudnn-7.0-win-x64-v4.0-prod.zip -o3rdparty\bin cuda\bin
		call .\tools\7z938-extra\7za.exe e -y cudnn-7.0-win-x64-v4.0-prod.zip -o3rdparty\include cuda\include
		del cudnn-7.0-win-x64-v4.0-prod.zip
		...
		echo ### Please download cudnn-7.0-win-x64-v4.0-prod.zip to your caffe root folder to proceed ###
		exit -1
	)
)
