if exist ".\3rdparty" (
	...
	if exist ".\cudnn-7.0-win-x64-v3.0-rc.zip" (
		call .\tools\wget_1.11.4_cygwin\wget.exe --no-check-cert https://www.dropbox.com/s/xtcodx7i5zlukza/3rdparty_caffe_27082015_win64.7z?dl=1 -O 3rdparty_tmp.7z
		call .\tools\7z938-extra\7za.exe x 3rdparty_tmp.7z
		del 3rdparty_tmp.7z
		call .\tools\7z938-extra\7za.exe e cudnn-7.0-win-x64-v3.0-rc.zip -o3rdparty\lib cuda\lib\x64
		call .\tools\7z938-extra\7za.exe e cudnn-7.0-win-x64-v3.0-rc.zip -o3rdparty\bin cuda\bin
		call .\tools\7z938-extra\7za.exe e cudnn-7.0-win-x64-v3.0-rc.zip -o3rdparty\include cuda\include
...
::		del cudnn-6.5-win-v2.zip
		...
		echo.
		echo ### Please download cudnn-7.0-win-x64-v3.0-rc.zip to your caffe root folder to proceed ###
		echo.
		exit 2
	)
