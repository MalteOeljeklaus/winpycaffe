...
/**
 * @brief Disclaimer: quick hack of DeepLab code to support weighted loss,
 *        header files and documentation below copied from BVLC, other code
 *        copied from https://bitbucket.org/deeplab/deeplab-public
 * 
...
*/
  ...
  /// name of the textfile containing the weights
...
/*
  ...
  */
  ...
  set<int> ignore_label_;
  /*
  /// How to normalize the output loss.
  LossParameter_NormalizationMode normalization_;
  deletion candidates above 
